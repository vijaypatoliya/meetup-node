...
declare class Events2 extends BaseClient {
  ...
  createEventComment(params: any): Promise<any>;

  getEventComment(eventCommentId: string): Promise<any>;

  deleteEventComment(eventCommentId: string): Promise<any>;

  createEventCommentFlag(params: any): Promise<any>;

  addEventCommentLike(eventCommentId: string): Promise<any>;

  deleteEventCommentLike(eventCommentId: string): Promise<any>;

  getEventCommentLikes(params: any): Promise<any>;

  addEventCommentSubscribe(eventCommentId: string): Promise<any>;

  deleteEventCommentSubscribe(eventCommentId: string): Promise<any>;

  getEventComments(params: any): Promise<any>;

  addEventRating(params: any): Promise<any>;

  getEventRatings(params: any): Promise<any>;

  getOpenEvents(params: any): Promise<any>;

}

declare class Groups2 extends BaseClient {

  uploadGroupPhoto(params: any): Promise<any>;
...
declare class Members2 extends BaseClient {
  ...
  uploadMemberPhoto(params: any): Promise<any>;
...
declare class Photos2 extends BaseClient {
  ...
  uploadEventPhoto(params: any): Promise<any>;

  updateEventPhoto(eventPhotoId: string, params: any): Promise<any>;

  deleteEventPhoto(eventPhotoId: string): Promise<any>;

  createPhotoAlbum(params: any): Promise<any>;

  getPhotoAlbums(params: any): Promise<any>;

  addPhotoComment(params: any): Promise<any>;

  getPhotoComments(params: any): Promise<any>;

  getPhotos(params: any): Promise<any>;

}

declare class Profiles2 extends BaseClient {

  createGroupProfile(params: any): Promise<any>;
...
declare class Rsvps2 extends BaseClient {
  ...
  createOrUpdateRsvp(params: any): Promise<any>;
...
declare class Boards extends BaseClient {
  ...
  getGroupDiscussionBoardsList(urlname: string): Promise<any>;

  getGroupDiscussionsList(urlname: string, bid: string): Promise<any>;

  getGroupDiscussionPostsList(urlname: string, bid: string, did: string): Promise<any>;
...
declare class Groups3 extends BaseClient {
  ...
  getGroup(urlname: string): Promise<any>;
...
declare class Notifications extends BaseClient {
...
declare class Photos3 extends BaseClient {
  ...
  deleteMemberPhoto(memberId: string, photoId: string): Promise<any>;

}

declare class Preferences extends BaseClient {

  getPreference(urlname: string, domain: string, params: any): Promise<any>;

  updatePreference(urlname: string, domain: any, params: any): Promise<any>;
